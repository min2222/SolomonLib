...
public class AddOBBPacket 
{
	private final UUID entityUUID;
	private final List<OBBData> data;

	public AddOBBPacket(UUID uuid, List<OBBData> data) 
	{
		this.entityUUID = uuid;
		this.data = data;
	}

	public static AddOBBPacket read(FriendlyByteBuf buf)
	{
		return new AddOBBPacket(buf.readUUID(), buf.readList(t -> OBBData.read(t)));
	}
	...
	public static boolean handle(AddOBBPacket message, Supplier<NetworkEvent.Context> ctx)
	{
		ctx.get().enqueueWork(() ->
		{
