...
public abstract class PlayerRendererMixin 
{
	...
	private Vec3 wrap_setupRotations_getViewVector(AbstractClientPlayer instance, float partialTick, Operation<Vec3> original)
	{
		Vec3 viewVector = original.call(instance, partialTick);
