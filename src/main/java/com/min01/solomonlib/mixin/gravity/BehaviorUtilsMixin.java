...
public class BehaviorUtilsMixin 
{
	...
	private static ItemEntity onInitItemEntity(Level level, double posX, double posY, double posZ, ItemStack itemStack, Operation<ItemEntity> operation, @Local float yOffset, @Local LivingEntity entity)
	{
	...
	private static void onSetDeltaMovement(ItemEntity itemEntity, Vec3 deltaMovement, Operation<Void> operation, @Local LivingEntity entity) 
	{
