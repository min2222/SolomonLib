...
public class AdvancedGroundPathNavigation<T extends Mob & IClimberEntity> extends GroundPathNavigation
{
	...
	public AdvancedGroundPathNavigation(T entity, Level worldIn)
	{
		this(entity, worldIn, true);
	}

	public AdvancedGroundPathNavigation(T entity, Level worldIn, boolean checkObstructions)
	{
