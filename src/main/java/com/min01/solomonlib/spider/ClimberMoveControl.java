...
public class ClimberMoveControl<T extends Mob & IClimberEntity> extends MoveControl 
{
		...
		else if(this.operation == Operation.MOVE_TO)
		{
			...
			else 
			{
				...
				if(jumpDir != null) 
				{
					...
					if(jumpController instanceof ClimberJumpControl) 
					{
						((ClimberJumpControl<?>) jumpController).setJumping(jumpDir);
					}
				}
				else 
				{
